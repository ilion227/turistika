	...
	<div class="row 200%">
		<div class="12u">
			...
			<section>
				...
				<ul class="contact">
					<li><a class="icon fa-facebook" href="https://www.facebook.com/franci.klavz?fref=ts"><span class="label">Facebook</span></a></li>
					<li><a class="icon fa-twitter" href="https://twitter.com/"><span class="label">Twitter</span></a></li>
					<li><a class="icon fa-instagram" href="https://www.instagram.com/liberjan98/"><span class="label">Instagram</span></a></li>
