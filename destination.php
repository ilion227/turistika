...
<div id="myModal" class="modal fade" role="dialog">
    ...
    <form id="form1" action="destination_mail.php" method="POST" >
        ...
        <p type="Sporočilo:"><input name="sporocilo" placeholder="Vnesite vaše sporočilo..."></p>
        <input type="hidden" name="id" value="<?php echo $id; ?>">
        <button type="submit" name="submit" id="button">Pošlji</button>
    </form>
</div>
...
<div id="destination-container">
    ...
    <div id="content-container">
        <div class="pull-left">
            ...
            <a class="btn btn-default" href="http://<?php echo $destination['www']; ?>" target="_blank"><i class="fa fa-globe"></i>&nbsp;&nbsp;Povezava</a>
        </div>
        ...
        <?php if(isset($destination['iframe'])){
            echo '<div class="iframe"><h2>Predstavitveni video:</h2><iframe width="560" height="315" src="'. $destination['iframe'] . '" frameborder="0" allowfullscreen></iframe></div>';
        } ?>
